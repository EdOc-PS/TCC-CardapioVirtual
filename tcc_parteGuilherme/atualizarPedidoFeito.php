...
include('conexao.php');
echo $_POST['idHidden'];
$selectUpdate = 'SELECT `img_produto`, `nm_produto`, `qtde_produto`, `obs_produto`, `preco_produto`, `total_produto`, `dataPedido_produto`, `status_pedido`, `id_pedido` FROM `pedido`';
