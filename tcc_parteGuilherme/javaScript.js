...
class Produto {
    ...
    enviaPedido(){
        ...
        var src = 'enviaPedido.php?data='+dataBrasil+'&imagem_produto='+img_produto+'&nome='+nm_produto+'&preco='+preco_produto+'&qtde='+qtde_produto+'&total='+total_produto+'&status='+status_pedido;
